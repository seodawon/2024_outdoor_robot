...
class Detect(Node):
    def __init__(self):
        ...
        self.weights = '/home/seunghun/NewGosung/src/yolov5/yolov5/best.pt' # 이 경로에 .pt 설치
        ...
        self.data = '/home/seunghun/NewGosung/src/yolov5/yolov5/data/coco.yaml'  # 있어도 없어도 이상이 없는데 왜인지 모르겠음 ;;;
